...
def build_default_registry() -> ToolRegistry:
    """Build the default MCP tool registry — 5 unified super-tools."""
    reg = ToolRegistry()

    # =========================================================================
    # 5 Unified Super-Tools (replaces 19 individual tools)
    # =========================================================================

    from .unified import UNIFIED_TOOLS

    for tool_def in UNIFIED_TOOLS:
        reg.register(Tool(
            name=tool_def["name"],
